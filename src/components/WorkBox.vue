    ...
    <div class="info">
      ...
      <div class="content">
        <div class="skilllinks">
          <div v-for="(link, index) in props.links" :key="index">{{link}}</div>
        </div>
        <p>
...
<style lang="scss" scoped>
  .project {
    ...
    @keyframes project-fade-right {
      from {
        opacity: 0;
        transform: perspective(1000px)  translate3d(0px, 0px, 10px) rotate3d(0, 1, 0, -45deg);
      }
      to {
        opacity: 1;
